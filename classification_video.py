...
def run(self):
    while True:
        ...
        # Display the processed frame (you can also save it)
        cv2.imshow("YOLOv5 Inference", batch_image_raw[0])
...
if __name__ == "__main__":
    ...
    try:
        ...
        thread1 = inferThread(yolov5_wrapper, cap)
        thread1.start()
        ...
        # Release resources and destroy the instance
