...
class YoLov5TRT(object):
    ...
    def xywh2xyxy(self, origin_h, origin_w, x):
        ...
        return y
    def process_mask(self, output_proto_mask, result_proto_coef, result_boxes, ih, iw, class_id):
    """
    ...
    param:
        ...
        result_boxes     :
        ih: rows of the original image
        iw: cols of the original image
        class_id: the class ID you want to extract masks for
    return:
        mask_result: (n, ih, iw)
    """
      ...
      for mask, box, class_idx in zip(masks, result_boxes, class_id):
    ...
    def post_process(self, output_boxes, origin_h, origin_w):
        ...
        """
        class_id_to_extract = 0  # Replace with the class ID you want to extract masks for
        result_masks = yolov5_wrapper.process_mask(output_proto_mask, result_proto_coef, result_boxes, batch_origin_h[i], batch_origin_w[i], class_id_to_extract)
